(function(){
  const dict={
    en:{
      ...
      urgentMsg:'Urgent support is recommended because an immediate safety concern, self-harm concern, immediate threat/violence, or severe functional impairment was selected.',
    ...
    bm:{
      ...
      detailsMore:'Ringkasan tindakan',
      otherTitle:'Isu Lain',
  ...
  const planBM=[
    ...
    ['Suggested review timing: Immediate review.','Cadangan masa semakan: semakan segera.'],
    ['Suggested review timing: 2 to 4 weeks.','Cadangan masa semakan: 2 hingga 4 minggu.'],
    ['Suggested review timing: 4 to 8 weeks.','Cadangan masa semakan: 4 hingga 8 minggu.'],
    ['Suggested review timing: 8 to 12 weeks.','Cadangan masa semakan: 8 hingga 12 minggu.'],
